 ...
 */
public class clickOnMediaTabInAllResults extends General {
  @Test
  public void testClickOnMediaTabInAllResults() throws InterruptedException {
        ...
        Thread.sleep(2000);
        theHub.clickOnTabInAllResults("Media");
