...
public class TheHub {
   ...
   /* public void clickOnAFacet(){
    ...
    public void filterUsingSingleSelectFacet(String singleSelectFilter,String sValue){
        ...
        System.out.println(collapsableFacets.size());
        for (int j = 0; j < collapsableFacets.size(); j++) {
            //  System.out.println(this.selectedFacet.get(j).getText());

            if (collapsableFacets.get(j).getText().contains(singleSelectFilter)){
                System.out.println(collapsableFacets.get(j).getText());
                collapsableFacets.get(j).click();

            }
            else {
                System.out.println("i am doing this wrong");
            }
            break;
        }
    }
